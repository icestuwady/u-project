...
<head>
    ...
    <title>Individual Productivity</title>
...
<body class="bg-dark">
  ...
  <div id="mySidenav" class="sidenav">
    ...
    <a href="show-Picking.php"><i class="fa fa-inbox"></i> Picking</a>
  ...
  <div class="container-fluid">
      <div class="row" style="padding-top:30px;">
        ...
        <?php
          ...
          $result = mysqli_query($conn,"SELECT * FROM `employee` WHERE error_target < 2 AND product >= targets;");
        ...
        <?php
          $conn = mysqli_connect("localhost","root","","project_pi");
          $result = mysqli_query($conn,"SELECT * FROM `employee` EXCEPT SELECT * FROM `employee`  WHERE error_target < 2 AND product >= targets;");
          $num = mysqli_num_rows($result);
          $i = 0;
        ?>
              ...
              <div class="slider">
                  <div class="owl-carousel">
                    ...
                    <div class="slider-card" style="padding:10px;">
                      ...
                      <h6 class="text-center" style="font-size: 12px;">Zone: <?php echo $row['zones'];?></h6>
                      <hr>
