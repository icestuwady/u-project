...
<body class="bg-dark">
  ...
  <div id="main">
    <h1>Individual Productivity Picking C</h1>
  </div>
  ...
  <div class="container-fluid">
      <div class="row" style="padding-top:30px;">
        ...
        <?php
          ...
          $result = mysqli_query($conn,"SELECT * FROM `employee` WHERE (lower(zones) LIKE 'pickingc%' OR lower(zones) LIKE 'picking c%') AND error_target < 2 AND product >= targets;");
        ...
        <?php
          $conn = mysqli_connect("localhost","root","","project_pi");
          $result = mysqli_query($conn,"SELECT * FROM `employee` WHERE (lower(zones) LIKE 'pickingc%' OR lower(zones) LIKE 'picking c%') EXCEPT SELECT * FROM `employee`  WHERE error_target < 2 AND product >= targets;");
          $num = mysqli_num_rows($result);
          $i = 0;
        ?>
